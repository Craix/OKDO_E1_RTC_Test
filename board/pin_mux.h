...
/*! @name PIO0_13 (number 71), OLED
  @{ */
#define OLED_SDA_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLED_SDA_PIN 13U                   /*!<@brief PORT pin number */
#define OLED_SDA_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                           /* @} */

/*! @name PIO0_14 (number 72), OLED
  @{ */
#define OLED_SCL_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLED_SCL_PIN 14U                   /*!<@brief PORT pin number */
#define OLED_SCL_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                           /* @} */
